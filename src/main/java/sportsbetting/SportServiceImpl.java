...
// @Transactional
// @Override
// public Bookie updateBookie(Long bookieId, Bookie bookieToUpdate) throws
// SportException {
...
// @Transactional
// @Override
// public Player updatePlayer(Long playerId, Player playerToUpdate) throws
// SportException {
...
// return betRepository.findAllByBookies(myBookie());
// }
//
// @Transactional
// @Override
...
//
// // playerRepository.findByPlayerId(myPlayer().getPlayerId());
// // betRepository.findAllByPlayers(this.player);
//
// Collection<Bet> playerBets = betRepository.findAllByPlayers(myPlayer());
...
// @Transactional
// @Override
// public Bookie getBookieByUserNameAndPassword(String userName, String
// password) throws SportException {
// return bookieRepository.findBookieByUserNameAndPassword(userName, password);
// }
//
// @Transactional
// @Override
// public Player getPlayerByUserNameAndPassword(String userName, String
// password) throws SportException {
...
// @Transactional
// @Override
// public SportServiceImpl adminLogin(ClientType clientType, String userName,
// String password) throws SportException {
...
// @Transactional
// @Override
// public SportServiceImpl bookieLogin(ClientType clientType, String userName,
// String password) throws SportException {
...
// @Transactional
// @Override
// public SportServiceImpl playerLogin(ClientType clientType, String userName,
// String password) throws SportException {
